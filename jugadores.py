JUGADORES_POPULARES = [
    ...
    "Neymar Jr", "Vinícius Jr", "Jude Bellingham", "Kevin De Bruyne",
    "Mohamed Salah", "Harry Kane", "Robert Lewandowski", "Luka Modric",
    "Toni Kroos", "Karim Benzema", "Luis Suárez",
